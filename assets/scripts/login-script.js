...
/**
* Membuat variabel inputEmailEmeent untnuk tampilan input email.
* @constant {HTMLElement}
*/
const inputEmailElement = document.querySelector('#inputEmail');

/**
* Membaut variabel inputPasswordElement untuk tampilan input password.
* @constant {HTMLElement}
*/
...
loginFormElement.addEventListener('submit', function(event) {
  ...
  if (email == expectedEmail && password == expectedPassword) {
    ...
    /* Comment : Namun jika tidak sesuai maka akan menampilkan informasi bahwa inpput salah. */
    showPopUp();
  }
});
